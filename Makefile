...
#    Updated: 2024/06/12 21:24:13 by irychkov         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #

NAME = so_long
SRCS = main.c ft_utils.c graphics.c control.c map_loading.c map_parsing.c path_validation.c map_validation.c map_validation2.c
OBJS = $(SRCS:.c=.o)
MLX_DIR = ./MLX42
