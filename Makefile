...
#    Updated: 2024/06/12 17:36:59 by irychkov         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #

NAME = so_long
SRCS = main.c ft_utils.c graphics.c control.c map_loading.c map_parsing.c path_validation.c map_validation.c map_validation2.c get_next_line_bonus.c get_next_line_utils_bonus.c
OBJS = $(SRCS:.c=.o)
MLX_DIR = ./MLX42
